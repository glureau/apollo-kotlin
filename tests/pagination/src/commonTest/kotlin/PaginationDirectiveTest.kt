...
import pagination.test.WithPaginationDirectiveQuery_TestBuilder.Data
import kotlin.test.Test
import kotlin.test.assertEquals

class PaginationDirectiveTest {
  @Test
  fun paginationDirectiveMemoryCache() {
    paginationDirective(MemoryCacheFactory())
  }

  @Test
  fun paginationDirectiveBlobSqlCache() {
    paginationDirective(SqlNormalizedCacheFactory(name = "blob", withDates = true))
  }

  @Test
  fun paginationDirectiveJsonSqlCache() {
    paginationDirective(SqlNormalizedCacheFactory(name = "json", withDates = false))
  }

  @Test
  fun paginationDirectiveChainedCache() {
    paginationDirective(MemoryCacheFactory().chain(SqlNormalizedCacheFactory(name = "json", withDates = false)))
  }

  private fun paginationDirective(cacheFactory: NormalizedCacheFactory) = runTest {
    ...
    // First page
    val query1 = WithPaginationDirectiveQuery(first = Optional.Present(2))
    val data1 = WithPaginationDirectiveQuery.Data {
    ...
    // Page after
    val query2 = WithPaginationDirectiveQuery(first = Optional.Present(2), after = Optional.Present("xx43"))
    val data2 = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = listOf(
            edge {
              cursor = "xx44"
    ...
    var expectedData = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = listOf(
            edge {
              cursor = "xx42"
    ...
    // Page after
    val query3 = WithPaginationDirectiveQuery(first = Optional.Present(2), after = Optional.Present("xx45"))
    val data3 = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = listOf(
            edge {
              cursor = "xx46"
    ...
    dataFromStore = apolloStore.readOperation(query1)
    expectedData = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = listOf(
            edge {
              cursor = "xx42"
    ...
    // Page before
    val query4 = WithPaginationDirectiveQuery(last = Optional.Present(2), before = Optional.Present("xx42"))
    val data4 = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = listOf(
            edge {
              cursor = "xx40"
    ...
    val query5 = WithPaginationDirectiveQuery(first = Optional.Present(2), after = Optional.Present("xx50"))
    val data5 = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = listOf(
            edge {
              cursor = "xx50"
    ...
    val query6 = WithPaginationDirectiveQuery(first = Optional.Present(2), after = Optional.Present("xx51"))
    val data6 = WithPaginationDirectiveQuery.Data {
      usersCursorBased2 = usersCursorBased2 {
        edges = emptyList()
      }
    }
